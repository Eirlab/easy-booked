...
class Assets {
    ...
    public function front_end_enqueue() {
        ...
        $primary_color   = isset( $options['color_primary'] ) ? $options['color_primary'] : '#41484C';
        $secondary_color = isset( $options['color_secondary'] ) ? $options['color_secondary'] : '#41484c';
        $tertiary_color  = isset( $options['color_tertiary'] ) ? $options['color_tertiary'] : '#39a9dc';
        $button_hover_color = isset( $options['color_hover'] ) ? $options['color_hover'] : '#39a9dc';
